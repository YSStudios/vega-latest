...
export default function CaseSubModal({
  ...
  const renderGallery = (galleryKey, images) => {
    const imageGrid = `${styles.image_grid} ${
  ...
  const renderPortrait = () => {
    ...
    if (assetType === "sanity.imageAsset") {
      ...
      return (
        <ProgressiveImage
          src={urlFor(portraitItem).format("webp").quality(80).fit("max").url()}
  ...
  return (
    <div className={`${styles.content_wrap} ${styles.subModal}`}>
      <ModalNav
        ...
        dispatch={dispatch}
      />
      <div className={styles.modal_content} ref={modalContentRef}>
        <div ref={maximizeRef} className={styles.modal_body}>
          ...
          <div className={styles.col3} ref={col3Ref}>
            <h1
